...
router.post('/cart', authMiddleware, authController.userCart);
router.put('/reset-password/:token', authController.resetPassword);
router.put('/change-password', authMiddleware, authController.updatePassword);
router.put('/save-address', authMiddleware, authController.saveAddress);
...
router.delete('/cart', authMiddleware, authController.emptyCart);
router.delete('/:id', authController.deleteUser);
router.get('/wishlist', authMiddleware, authController.getWishList);
router.get('/cart', authMiddleware, authController.getUserCart);
